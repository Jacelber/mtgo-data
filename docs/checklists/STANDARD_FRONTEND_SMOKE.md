...
3. Select 1, 4, 12, and 36 weeks; confirm the metagame table and deck details load for each range.
4. Open Weekly Pickup; confirm its week selector and the selected report load.
5. Open Matchups; select 1, 4, 12, and 36 weeks and confirm the overall table and matrix render.
