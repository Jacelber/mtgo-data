# Completed and superseded roadmap history

This file preserves roadmap material removed from the live planning document by
GOV-11. It is historical and non-authoritative. Use `docs/STATUS.yaml` for
current authorization and `docs/ROADMAP.md` for current and future planning.
...
## Superseded phase specifications formerly embedded in the live roadmap
...
## Retired duplicated roadmap procedures
