...
`docs/audits/CARD_LOCALIZATION_RIGHTS_REVIEW_20260829.md` and DEC-137. They do
not authorize a source fetch or `L10N-B`; they define the fail-closed contract
that a separately authorized real-source task must satisfy.
